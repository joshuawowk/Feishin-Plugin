...
if (typeof Action === 'undefined') {
    ...
    const playPauseAction = new Action('net.jwowk.feishin-remote.sdPlugin.playpause');
    const nextAction = new Action('net.jwowk.feishin-remote.sdPlugin.next');
    const previousAction = new Action('net.jwowk.feishin-remote.sdPlugin.previous');
    const shuffleAction = new Action('net.jwowk.feishin-remote.sdPlugin.shuffle');
    const repeatAction = new Action('net.jwowk.feishin-remote.sdPlugin.repeat');
    const volumeUpAction = new Action('net.jwowk.feishin-remote.sdPlugin.volumeup');
    const volumeDownAction = new Action('net.jwowk.feishin-remote.sdPlugin.volumedown');
